...
#define NANVIX_KLIB_H_
	...
	/**
	 * @brief Compares two numbers and returns the largest.
	 *
	 * @param n1 Number 1.
	 * @param n2 Number 2.
	 *
	 * @return Returns the largest of the two numbers.
	 */
	#define KMAX(a,b) ((a) > (b) ? (a) : (b))

	/**
	 * @brief Compares two numbers and returns the smallest.
	 *
	 * @param n1 Number 1.
	 * @param n2 Number 2.
	 *
	 * @return Returns the smallest of the two numbers.
	 */
